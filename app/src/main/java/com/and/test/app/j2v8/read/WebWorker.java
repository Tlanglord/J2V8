...
/**
 * Created by dongqiangqiang on 2021/4/8.
 *
 */
public class WebWorker {

    public void worker(V8Object worker, String... s) {
    ...
    private void configureWorker(V8 runtime) {
        runtime.registerJavaMethod(this, "worker", "Worker", new Class<?>[]{V8Object.class, String[].class}, true);
